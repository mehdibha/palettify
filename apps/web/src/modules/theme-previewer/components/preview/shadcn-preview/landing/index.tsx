...
import { CommandIcon } from "@palettify/ui";
import { cn } from "@palettify/utils";
import { buttonVariants } from "@/modules/shadcn-ui/ui/button";
    ...
    <div>
      <header className="bg-background container z-40">
        <nav className="flex justify-between py-4">
          ...
          <Link href="#" className={cn(buttonVariants({ variant: "secondary" }), "px-4")}>
            Login
          </Link>
        </nav>
      </header>
      <section className="space-y-6 pt-28">
        <div className="container flex flex-col items-center gap-4 text-center">
          ...
          <h1 className="max-w-3xl text-5xl font-bold">
            Elevating Your Business with Seamless Solutions
          </h1>
          <p className="text-muted-foreground leading-normal sm:text-xl sm:leading-8">
            Unlock Efficiency, Scale Seamlessly, and Thrive in the Digital Era with
            Acme&apos;s Innovative Software Services.
          </p>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="text-muted-foreground max-w-[85%] leading-normal sm:text-lg sm:leading-7">
            This project is an experiment to see how a modern app, with features like
            auth, subscriptions, API routes, and static pages would work in Next.js 13 app
            dir.
          </p>
        </div>
        <div className="mx-auto grid max-w-[64rem] grid-cols-2 justify-center gap-4 xl:grid-cols-3">
        ...
        <div className="mx-auto text-center md:max-w-[58rem]">
          <p className="text-muted-foreground leading-normal sm:text-lg sm:leading-7">
            Acme also includes a blog and a full-featured documentation site built using
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="text-muted-foreground max-w-[85%] leading-normal sm:text-lg sm:leading-7">
            Acme is open source and powered by open source software. <br /> The code is
            available on{" "}
            <Link
